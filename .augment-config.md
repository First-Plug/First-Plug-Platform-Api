...
- ✅ **Seguir patrón `fpWarehouse`** como referencia para implementación
...
**✅ Métodos que YA implementan el patrón:**
...
- `handleProductFromProductsCollection` - Con construcción básica
- `handleProductUnassignment` - Con construcción básica

**⚠️ Al agregar nuevos métodos de movimiento:**

1. Verificar si maneja `location === 'Our office'`
2. Aplicar patrón de asignación con persistencia si es necesario
3. Seguir patrón `fpWarehouse` como referencia
