...
- ✅ **Se calcula `expiresAt`** = createdAt + 30 días
- ✅ **Cron diario** busca attachments con `expiresAt < now`
- ✅ **Si encuentra**: borra de Cloudinary + remueve de Quote
- ✅ **Si user hace submit**: imagen ya está en Quote, no se borra
...
**Razón**: Opción A permite preview antes de submit, con cleanup automático para imágenes abandonadas.
